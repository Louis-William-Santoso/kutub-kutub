...
CREATE TABLE IF NOT EXISTS `kutube_db`.`playlist` (
  ...
  `judul_playlist` TINYTEXT NOT NULL,
  `description` LONGTEXT NULL,
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`donation` (
  ...
  INDEX `fk_donation_user1_idx` (`id_sender` ASC),
  INDEX `fk_donation_user2_idx` (`id_receiver` ASC),
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`post_image` (
  ...
  INDEX `fk_post_image_user1_idx` (`id_user` ASC),
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`report_posting` (
  ...
  INDEX `fk_report_posting_post_image1_idx` (`id_image` ASC),
  INDEX `fk_report_posting_user1_idx` (`user_id_user` ASC),
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`post_has_kategori_hastag` (
  ...
  INDEX `fk_post_image_has_hastag_hastag1_idx` (`id_hastag` ASC),
  INDEX `fk_post_image_has_hastag_post_image1_idx` (`id_image` ASC),
  INDEX `fk_post_image_has_hastag_kategori1_idx` (`id_kategori` ASC),
