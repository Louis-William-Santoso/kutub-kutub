...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`comments_video` (
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`video_has_hastag_kategori` (
  `kategori_id_kategori` INT NOT NULL DEFAULT 0,
  `hastag_id_hastag` INT NOT NULL DEFAULT 0,
  `video_id_video` INT NOT NULL,
  ...
  INDEX `fk_kategori_has_hastag_video1_idx` (`video_id_video` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`blocked_video` (
  `id_video` INT NOT NULL,
  `start_suspend` TIMESTAMP NULL,
  `end_suspend` TIMESTAMP NULL,
  PRIMARY KEY (`id_video`),
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`trending_video` (
  ...
  `id_video` INT NOT NULL,
  INDEX `fk_trending_video_video_has_hastag_kategori1_idx` (`id_kategori` ASC, `id_hastag` ASC, `id_video` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`report_coment` (
  `id_user` INT NOT NULL,
  `id_comments` INT NOT NULL,
  `description` LONGTEXT NULL,
  INDEX `fk_report_content_comments1_idx` (`id_comments` ASC) VISIBLE,
  INDEX `fk_report_content_user1_idx` (`id_user` ASC) VISIBLE,
  CONSTRAINT `fk_report_coment_comments1`
    FOREIGN KEY (`id_comments`)
    REFERENCES `kutube_db`.`comments_video` (`id_comments`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_report_coment_user1`
    FOREIGN KEY (`id_user`)
    REFERENCES `kutube_db`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`report_video` (
  ...
  `id_video` INT NOT NULL,
  `description` LONGTEXT NULL,
  INDEX `fk_report_video_user1_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_report_video_video1_idx` (`id_video` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`downloaded_video` (
  `id_downloaded` INT NOT NULL AUTO_INCREMENT,
  `id_user` INT NOT NULL,
  `id_video` INT NOT NULL,
  `downloaded_time` VARCHAR(45) NULL,
  PRIMARY KEY (`id_downloaded`, `id_user`, `id_video`),
  INDEX `fk_user_has_video_video1_idx` (`id_video` ASC) VISIBLE,
  INDEX `fk_user_has_video_user1_idx` (`id_user` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kutube_db`.`adsense` (
  ...
  `ads_aktif` TINYINT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id_video`),
  INDEX `fk_adsense_video1_idx` (`id_video` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`donation` (
  `id_donation` INT NOT NULL AUTO_INCREMENT,
  `id_sender` INT NOT NULL,
  `id_reciver` INT NOT NULL,
  `jumlah_donasi` INT NOT NULL DEFAULT 1.000,
  PRIMARY KEY (`id_donation`),
  INDEX `fk_donation_user1_idx` (`id_sender` ASC) VISIBLE,
  INDEX `fk_donation_user2_idx` (`id_reciver` ASC) VISIBLE,
  CONSTRAINT `fk_donation_user1`
    FOREIGN KEY (`id_sender`)
    REFERENCES `kutube_db`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_donation_user2`
    FOREIGN KEY (`id_reciver`)
    REFERENCES `kutube_db`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`post_image` (
  ...
  INDEX `fk_post_image_user1_idx` (`id_user` ASC) VISIBLE,
  CONSTRAINT `fk_post_image_user1`
    FOREIGN KEY (`id_user`)
    REFERENCES `kutube_db`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`report_posting` (
  `id_report` INT NOT NULL AUTO_INCREMENT,
  `id_image` INT NOT NULL,
  `user_id_user` INT NOT NULL,
  `description` VARCHAR(45) NULL,
  PRIMARY KEY (`id_report`),
  INDEX `fk_report_posting_post_image1_idx` (`id_image` ASC) VISIBLE,
  INDEX `fk_report_posting_user1_idx` (`user_id_user` ASC) VISIBLE,
  CONSTRAINT `fk_report_posting_post_image1`
    FOREIGN KEY (`id_image`)
    REFERENCES `kutube_db`.`post_image` (`id_image`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_report_posting_user1`
    FOREIGN KEY (`user_id_user`)
    REFERENCES `kutube_db`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kutube_db`.`post_has_kategori_hastag` (
  `id_image` INT NOT NULL,
  `id_hastag` INT NOT NULL DEFAULT 0,
  `id_kategori` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_image`, `id_hastag`, `id_kategori`),
  INDEX `fk_post_image_has_hastag_hastag1_idx` (`id_hastag` ASC) VISIBLE,
  INDEX `fk_post_image_has_hastag_post_image1_idx` (`id_image` ASC) VISIBLE,
  INDEX `fk_post_image_has_hastag_kategori1_idx` (`id_kategori` ASC) VISIBLE,
  CONSTRAINT `fk_post_image_has_hastag_post_image1`
    FOREIGN KEY (`id_image`)
    REFERENCES `kutube_db`.`post_image` (`id_image`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_post_image_has_hastag_hastag1`
    FOREIGN KEY (`id_hastag`)
    REFERENCES `kutube_db`.`hastag` (`id_hastag`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_post_image_has_hastag_kategori1`
